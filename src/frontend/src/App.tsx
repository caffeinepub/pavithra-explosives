      ...
      <div className="home-welcome">
        ...
        <div
          style={{
            ...
            width: 48,
            background:
              "linear-gradient(90deg, oklch(0.55 0.18 30), oklch(0.65 0.18 55))",
            borderRadius: 2,
            margin: "0 auto",
          }}
        />
...
function IndentScreen({ navigate, actor }: IndentScreenProps) {
  ...
  return (
    <div className="screen">
      ...
      {/* Section 1: Quarry Details */}
      <div className="indent-section">
        <div className="indent-section-label">
          <MapPin size={12} /> Quarry Details
        </div>
        <input
      ...
      {/* Section 2: License & Date */}
      <div className="indent-section">
        <div className="indent-section-label">
          <FileText size={12} /> License &amp; Date
        </div>
        <input
          className="form-input"
      ...
      {/* Section 3: Explosive Items Table */}
      <div className="indent-section">
        <div className="indent-section-label">
          <Flame size={12} /> Explosive Items
        </div>
        <div className="overflow-x-auto">
          <table className="indent-table">
            <thead>
              <tr>
                <th style={{ width: 32 }}>SL</th>
                <th style={{ textAlign: "left", paddingLeft: 8 }}>Item</th>
...
function BlasterViewScreen({
  ...
  return (
    <div className="screen">
      <h2 className="screen-title flex items-center justify-center gap-2">
        <Search className="h-5 w-5" style={{ color: "oklch(var(--navy))" }} />{" "}
        Blaster Order View
      </h2>

      <div className="filter-section">
        <div className="filter-section-label">
          <Search size={12} /> Search Orders
        </div>
        <input
          className="form-input"
        ...
        <button
          ...
          style={{
            background:
              "linear-gradient(135deg, oklch(0.52 0.15 220), oklch(0.4 0.13 230))",
            boxShadow: "0 3px 10px oklch(0.52 0.15 220 / 0.35)",
          }}
    ...
    <div className="screen">
      ...
      <div className="login-card">
        <div
          ...
          style={{
            background:
              "linear-gradient(90deg, oklch(0.48 0.14 200), oklch(0.38 0.12 210))",
          }}
        />
        <div className="login-card-body">
          <div
            className="login-icon-circle"
            style={{
              background:
                "linear-gradient(135deg, oklch(0.48 0.14 200 / 0.12), oklch(0.38 0.12 210 / 0.2))",
              border: "1.5px solid oklch(0.48 0.14 200 / 0.3)",
            }}
          >
            <Truck
              className="h-8 w-8"
              style={{ color: "oklch(0.38 0.12 210)" }}
            />
          </div>
          <p className="login-title">Driver Panel</p>
      ...
      <button
        ...
        style={{
          background:
            "linear-gradient(135deg, oklch(0.48 0.14 200), oklch(0.38 0.12 210))",
          boxShadow: "0 3px 10px oklch(0.48 0.14 200 / 0.35)",
        }}
        onClick={handleLogin}
        ...
        <div className="flex gap-2 items-center">
          ...
          <button
            ...
            style={{
              ...
              background:
                "linear-gradient(135deg, oklch(0.48 0.14 200), oklch(0.38 0.12 210))",
              boxShadow: "0 2px 8px oklch(0.48 0.14 200 / 0.35)",
            }}
    ...
    <div className="screen">
      ...
      <div className="login-card">
        <div
          ...
          style={{
            background:
              "linear-gradient(90deg, oklch(0.32 0.08 245), oklch(0.22 0.07 250))",
          }}
        />
        <div className="login-card-body">
          <div
            ...
            style={{
              background:
                "linear-gradient(135deg, oklch(0.32 0.08 245 / 0.12), oklch(0.22 0.07 250 / 0.2))",
              border: "1.5px solid oklch(0.32 0.08 245 / 0.3)",
            }}
          >
            <ShieldCheck
              className="h-8 w-8"
          ...
          <p className="login-title">Manager Panel</p>
          <p className="login-subtitle">Enter your password to continue</p>
      ...
      <button
        ...
        style={{
          background:
            "linear-gradient(135deg, oklch(0.32 0.08 245), oklch(0.22 0.07 250))",
          boxShadow: "0 3px 10px oklch(0.32 0.08 245 / 0.4)",
        }}
        onClick={handleLogin}
        ...
        <div className="flex gap-2 items-center">
          ...
          <button
            ...
            style={{
              ...
              background:
                "linear-gradient(135deg, oklch(0.32 0.08 245), oklch(0.22 0.07 250))",
              boxShadow: "0 2px 8px oklch(0.32 0.08 245 / 0.4)",
            }}
            onClick={handleFilter}
            disabled={loading}
    ...
    <div className="screen">
      ...
      <div className="login-card">
        <div
          ...
          style={{
            background:
              "linear-gradient(90deg, oklch(0.45 0.12 280), oklch(0.35 0.1 290))",
          }}
        />
        <div className="login-card-body">
          <div
            ...
            style={{
              background:
                "linear-gradient(135deg, oklch(0.45 0.12 280 / 0.12), oklch(0.35 0.1 290 / 0.2))",
              border: "1.5px solid oklch(0.45 0.12 280 / 0.3)",
            }}
          >
            <Building2
              className="h-8 w-8"
              style={{ color: "oklch(0.38 0.12 285)" }}
            />
          </div>
          <p className="login-title">Office Panel</p>
          <p className="login-subtitle">Enter your password to continue</p>
      ...
      <button
        ...
        style={{
          background:
            "linear-gradient(135deg, oklch(0.45 0.12 280), oklch(0.35 0.1 290))",
          boxShadow: "0 3px 10px oklch(0.45 0.12 280 / 0.35)",
        }}
        onClick={handleLogin}
        ...
        <div className="flex gap-2 items-center">
          ...
          <button
            ...
            style={{
              ...
              background:
                "linear-gradient(135deg, oklch(0.45 0.12 280), oklch(0.35 0.1 290))",
              boxShadow: "0 2px 8px oklch(0.45 0.12 280 / 0.35)",
            }}
            onClick={handleFilter}
            disabled={loading}
